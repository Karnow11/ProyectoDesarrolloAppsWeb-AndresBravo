...
function cargarRegion(){
    ...
    for(let region in region_comuna.regiones){
        /*console.log(region_comuna.regiones[region].nombre)*/
        var opcion = document.createElement("option")
        opcion.value = region
        opcion.text = region_comuna.regiones[region].nombre
...
function cargarComunas(){
    ...
    for(let comuna in region_comuna.regiones[region].comunas){
        ...
        opcion.text = region_comuna.regiones[region].comunas[comuna].nombre
        select.appendChild(opcion)
    }
}

function addTextInput(checkbox){
    console.log("Loolin")
    ...
    if (checkbox.checked){
        ...
        let input = document.getElementById(checkbox.id + "_input")
        if(input){
...
var pic_num = 1
function addPicSelect(button){
    var div = button.closest('div')
    if(div && pic_num <5){
        pic_num += 1
        let pic_button = document.createElement("input")
        pic_button.type = "file"
        pic_button.accept = "image/*"
        div.appendChild(pic_button)
    }
}
...
const wsp_checkbox = document.getElementById("wsp_checkbox")
const tele_checkbox = document.getElementById("tele_checkbox")
const x_checkbox = document.getElementById("x_checkbox")
const inst_checkbox = document.getElementById("inst_checkbox")
const tik_checkbox = document.getElementById("tik_checkbox")
...
const more_pic_button = document.getElementById("more-pic")
more_pic_button.addEventListener("click",function(){
    addPicSelect(this)
})
